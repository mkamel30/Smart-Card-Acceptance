...
export default function ReceiptUpload() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            alert('فشل معالجة الوصول بالذكاء الاصطناعي');
        } finally {
            setUploading(false);
        }
    };
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 text-right" dir="rtl">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                <p className="text-gray-500 mb-6">قم بتحميل صورة الوصول لاستخراج البيانات تلقائياً</p>
                        ...
                        {!extractedData ? (
                            ...
                            <div className="bg-green-50 border border-green-200 p-6 rounded-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <div className="mt-8 space-y-3">
                                    ...
                                    <p className="text-center text-xs text-green-600">سيتم استخدام هذه البيانات لتحديث سجل التسوية تلقائياً</p>
                                </div>
                            </div>
                        )}
                    </div>
